    ...
    return (
        <Stack>
            <Grid container spacing={1}>
                <Grid item xs={8}>
                    <Stack direction={"row"} alignItems="center" onClick={handleChange} sx={{ display: "inline-flex", cursor: "pointer" }}>
                        <Box sx={{ px: 1, py: "6px", bgcolor: type === "group" ? "#7246da" : "#32bdbe", borderRadius: "50%" }}>
